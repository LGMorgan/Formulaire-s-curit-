...
var exports = {};
exports.id = 2537;
exports.ids = [2537,8999,3449,5359,4060,5698,8380,403,8667,1715,5035,2655];
exports.modules = {
...
const GetSection = zod__WEBPACK_IMPORTED_MODULE_4__.z.object({
  // This accepts type of undefined, but is required at runtime
  id: zod__WEBPACK_IMPORTED_MODULE_4__.z.number().optional().refine(Boolean, "Required")
});
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,next_data_client__WEBPACK_IMPORTED_MODULE_0__.buildRpcResolver)(next_stdlib_server__WEBPACK_IMPORTED_MODULE_2__.resolver.pipe(next_stdlib_server__WEBPACK_IMPORTED_MODULE_2__.resolver.zod(GetSection), next_stdlib_server__WEBPACK_IMPORTED_MODULE_2__.resolver.authorize(), async ({
  id
}) => {
  // TODO: in multi-tenant app, you must add validation to ensure correct tenant
  const section = await db__WEBPACK_IMPORTED_MODULE_3__.default.section.findFirst({
    where: {
      id,
      include: {
        question: true
  ...
  if (!section) throw new next_stdlib__WEBPACK_IMPORTED_MODULE_1__.NotFoundError();
  return section;
}), {
  "resolverName": "getSection",
  "resolverType": "query",
  "routePath": "/api/rpc/getSection"
}));
...
var __webpack_exports__ = (__webpack_exec__(8652));
