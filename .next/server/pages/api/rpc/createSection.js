...
var exports = {};
exports.id = 9696;
exports.ids = [9696,8999,3449,5359,4060,5698,8380,403,8667,1715,5035,2655];
exports.modules = {
...
const CreateSection = zod__WEBPACK_IMPORTED_MODULE_3__.z.object({
  name: zod__WEBPACK_IMPORTED_MODULE_3__.z.string()
});
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,next_data_client__WEBPACK_IMPORTED_MODULE_0__.buildRpcResolver)(next_stdlib_server__WEBPACK_IMPORTED_MODULE_1__.resolver.pipe(next_stdlib_server__WEBPACK_IMPORTED_MODULE_1__.resolver.zod(CreateSection), next_stdlib_server__WEBPACK_IMPORTED_MODULE_1__.resolver.authorize(), async input => {
  // TODO: in multi-tenant app, you must add validation to ensure correct tenant
  const section = await db__WEBPACK_IMPORTED_MODULE_2__.default.section.create({
    data: input
  });
  return section;
}), {
  "resolverName": "createSection",
  "resolverType": "mutation",
  "routePath": "/api/rpc/createSection"
}));
...
var __webpack_exports__ = (__webpack_exec__(6251));
