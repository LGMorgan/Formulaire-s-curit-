...
var exports = {};
exports.id = 9018;
exports.ids = [9018,8999,3449,5359,4060,5698,8380,403,8667,1715,5035,2655];
exports.modules = {
...
const CreateQuestion = zod__WEBPACK_IMPORTED_MODULE_3__.z.object({
  name: zod__WEBPACK_IMPORTED_MODULE_3__.z.string()
});
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,next_data_client__WEBPACK_IMPORTED_MODULE_0__.buildRpcResolver)(next_stdlib_server__WEBPACK_IMPORTED_MODULE_1__.resolver.pipe(next_stdlib_server__WEBPACK_IMPORTED_MODULE_1__.resolver.zod(CreateQuestion), next_stdlib_server__WEBPACK_IMPORTED_MODULE_1__.resolver.authorize(), async input => {
  // TODO: in multi-tenant app, you must add validation to ensure correct tenant
  const question = await db__WEBPACK_IMPORTED_MODULE_2__.default.question.create({
    data: input
  });
  return question;
}), {
